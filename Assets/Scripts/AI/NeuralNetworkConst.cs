...
public class NeuralNetworkConst
{
    ...
    public static int NUMBER_OF_ELITE_COPYS = 1;
    ...
    public static int DEFENSE_INPUT_COUNT = 7;
    public static int DEFENSE_OUTPUT_COUNT = 3;
    public static int DEFENSE_HID_LAYER_COUNT = 1;
