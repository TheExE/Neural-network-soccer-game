...
public class NeuralNetworkConst
{
    ...
    public static int NUMBER_OF_ELITE = 8;
    ...
    public static int GOLY_INPUT_COUNT = 1;
    public static int GOLY_OUTPUT_COUNT = 1;
    public static int GOLY_HID_LAYER_COUNT = 2;
    public static int GOLY_NEURONS_PER_HID_LAY = 4;
    ...
    public static int TOURNAMENT_COMPETITIORS = 12;
